...
public class StandardHuffmanIO extends AbstractIO implements ReaderWriter<StandardHuffmanCompressedFileInfo, StandardHuffmanDecompressedFileInfo, StandardHuffmanCompressionInfo, StandardHuffmanDecompressionInfo> {
  @Override
