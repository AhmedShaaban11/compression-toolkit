...
public class TwoDPredictionIO extends AbstractIO implements ReaderWriter<TwoDPredictionCompressedFileInfo, TwoDPredictionDecompressedFileInfo, TwoDPredictionCompressionInfo, TwoDPredictionDecompressionInfo> {
  @Override
